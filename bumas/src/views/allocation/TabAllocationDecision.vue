<template>
  <div class="allocation-decision-container" id="allocationDecision">
    <div class="allocation-decision-title">
      <div class="row">
        <div class="item name col-2">TÊN QUYẾT ĐỊNH GIAO</div>

        <div class="item decision-date col-2">NGÀY QUYẾT ĐỊNH GIAO</div>
        <div class="item created-by col-2">PHƯƠNG ÁN PHÂN BỔ</div>
        <div class="item created-by col-2">LOẠI GIAO</div>
      ...
      <div class="allocation-decision-item">
        <div class="item add-allocation-decision">
          <div class="wrap-content" id="btnAddSubmit">
            ...
            <div class="item-name">Thêm quyết định giao</div>
          </div>
        </div>
        <div class="list-item">
          <div class="wrap-item">
            <div class="item">
              <div class="content-row row">
                <div class="item-content name col-2">
                  <div class="main-info">
                    <div class="ic-edit"></div>
                    <div class="item-name text-item">Quyết định giao 1</div>
                  </div>
                </div>
                ...
                <div class="item-content item-created-by created-by col-2">
                  <div class="text-item text-item">Phương án phân bổ 1</div>
                </div>
                <div class="item-content item-created-by created-by col-2">
                  <div class="text-item text-item">Giao đầu năm</div>
                </div>
